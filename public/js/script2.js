...
$(document).ready(function () {
    ...
    $(".user-language_plus").on("click",function(){
        if($(".language_added").length > 0){
            ...
            if(id!=""){
                ...
                $(".language_added").append('<input type="text" class="col-lg-4 label_language_'+id+'">\n<select class="col-lg-7 select_language_' + id + '"><option value="0">Не выбрано</option><option value="A1">A1</option><option value="A2">A2</option><option value="B1">B1</option><option value="B2">B2</option><option value="C1">C1</option><option value="C2">C2</option></select>');
            }
        }
    ...
    $(".check").on("click",function(){
        ...
        if(errors != '' ){
            ...
            $("#message").fadeIn("slow").html("<p class='alert alert-danger' style = 'background: #46c765;color: white;'>Проверка прошла успешно</p>").delay(2000).fadeOut();
        }
