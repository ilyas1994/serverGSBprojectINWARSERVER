...
namespace DaveJamesMiller\Breadcrumbs\Facades {
     ...
     * @see \Illuminate\Support\Traits\Macroable::macro
     * @method static void macro(string $name, callable|object $macro)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::before
     * @method static void before(callable $callback)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::for
     * @method static void for(string $name, callable $callback)
     * @see \Illuminate\Support\Traits\Macroable::mixin
     * @method static void mixin(object $mixin, bool $replace = true)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::current
     * @method static null|\stdClass current()
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::view
     * @method static \Illuminate\Support\HtmlString view(string $view, string $name = null, ...$params)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::setCurrentRoute
     * @method static void setCurrentRoute(string $name, ...$params)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::clearCurrentRoute
     * @method static void clearCurrentRoute()
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::exists
     * @method static bool exists(string $name = null)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::after
     * @method static void after(callable $callback)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::render
     * @method static \Illuminate\Support\HtmlString render(string $name = null, ...$params)
     * @see \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager::generate
...
namespace SleepingOwl\Admin\Facades {
    ...
    /**
     * @see \SleepingOwl\Admin\Admin::template
     * @method static \SleepingOwl\Admin\Contracts\Template\TemplateInterface template()
     * @see \SleepingOwl\Admin\Admin::getModel
     * @method static mixed|null|\SleepingOwl\Admin\Contracts\ModelConfigurationInterface getModel(object|string $class)
     * @see \SleepingOwl\Admin\Admin::registerModel
     * @method static \SleepingOwl\Admin\Admin|\SleepingOwl\Admin\Contracts\AdminInterface registerModel(string $class, \Closure $callback = null)
     * @see \SleepingOwl\Admin\Admin::navigation
     * @method static \SleepingOwl\Admin\Contracts\Navigation\NavigationInterface navigation()
     * @see \SleepingOwl\Admin\Admin::view
     * @method static \Illuminate\Contracts\View\Factory|\Illuminate\View\View view(\Illuminate\Contracts\Support\Renderable|string $content, null|string $title = null)
     * @see \SleepingOwl\Admin\Traits\DatePicker::setPickerFormat
     * @method static \SleepingOwl\Admin\Traits\DatePicker setPickerFormat(string $pickerFormat)
     * @see \SleepingOwl\Admin\Traits\MaxFileSizeTrait::getMaxFileSize
     * @method static int|number getMaxFileSize()
     * @see \SleepingOwl\Admin\Traits\DatePicker::getJsPickerFormat
     * @method static string getJsPickerFormat()
     * @see \SleepingOwl\Admin\Admin::getMissedSections
     * @method static array getMissedSections()
     * @see \SleepingOwl\Admin\Admin::setModel
     * @method static \SleepingOwl\Admin\Admin setModel(string $class, \SleepingOwl\Admin\Contracts\ModelConfigurationInterface $model)
     * @see \SleepingOwl\Admin\Admin::hasModel
     * @method static bool hasModel(string $class)
     * @see \SleepingOwl\Admin\Admin::addMenuPage
     * @method static mixed addMenuPage($class = null, int $priority = 100)
     * @see \SleepingOwl\Admin\Traits\MaxFileSizeTrait::convertKB
     * @method static float|int|number|string convertKB(string $value)
     * @see \SleepingOwl\Admin\Admin::setTemplate
     * @method static void setTemplate(\SleepingOwl\Admin\Contracts\Template\TemplateInterface $template)
     * @see \SleepingOwl\Admin\Admin::registerSections
     * @method static \SleepingOwl\Admin\Admin registerSections(array $sections)
     * @see \SleepingOwl\Admin\Traits\DatePicker::getPickerFormat
     * @method static string getPickerFormat()
     * @see \SleepingOwl\Admin\Admin::meta
     * @method static \SleepingOwl\Admin\Contracts\Template\MetaInterface meta()
     * @see \SleepingOwl\Admin\Configuration\ProvidesScriptVariables::scriptVariables
     * @method static array scriptVariables()
     * @see \SleepingOwl\Admin\Admin::initialize
     * @method static void initialize()
     * @see \SleepingOwl\Admin\Admin::getModels
     * @method static \SleepingOwl\Admin\Contracts\ModelConfigurationInterface[]|\SleepingOwl\Admin\Model\ModelCollection getModels()
     * @see \SleepingOwl\Admin\Admin::register
     * @method static \SleepingOwl\Admin\Admin register(\SleepingOwl\Admin\Contracts\ModelConfigurationInterface $model)
     */
    class Admin {}
}
